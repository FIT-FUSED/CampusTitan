                ...
                >
                    ...
                    >
                        <View style={s.aiCardContent}>
                            ...
                            <View style={{ flex: 1 }}>
                                <Text style={s.aiCardTitle}>AI Health Insights</Text>
                                <Text style={s.aiCardSub}>Get a personalized health summary powered by your Campus Titan AI model</Text>
                            </View>
                            <Text style={s.aiCardArrow}>→</Text>
                        </View>
                    </LinearGradient>
                </TouchableOpacity>
